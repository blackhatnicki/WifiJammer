...
function banner () {
	printf "${BD}
${GR}┊┊                  ${WH}╭━━━━━━
${GR}┊┊┊┊${YW}╭━╱▔▔▔╲━╮${GR}┊┊${YW}☼   ${WH}╭╯${RD}Suman
${GR}┊╱╲┊${YW}╰▏▆┊┊┊▇▕╯${GR}╱╲┊   ${WH}┃${RD}OnlineHacking ${NT}${CY}v1.2${BD}
${GR}▔▔▔▔▔${YW}▏┊┊▇┊┊▕${GR}▔▔▔▔   ${WH}╰┳━━━━━━
${GR}┈${YW}╱▔▔╱┊┊━┻━┊┊╲▔▔╲  ${WH}━━╯${YW}
${GR}┈${YW}╲▂╱╭━━╮┊╭━━╮╲▂╱
...
function get_interface () {
	...
	echo -ne "\n${RD}4WSec${GR}@${RDSuman: ${WH}>> "; read iface
...
printf " ${WH}4) ${GR}Exit\n"
echo -ne "\n${RD}4WSec${GR}@${RD}Suman: ${WH}>> "; read attack
clear
...
if [[ $attack == 1 ]]; then
	...
	printf "${NT}\n"
	nmcli dev wifi
	echo -ne "\n${RD}4WSec${GR}@${RD}Suman OnlineHacking: ${WH}>> "; read attck_chnl
	clear
	banner
	get_interface
	clear
